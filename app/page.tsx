...
const page = () => {
  return (
    <div className="conatinerb flex items-center justify-center pt-16 relative">
      <div className="w-1/2">
      ...
      <div className="px-8 py-12 bg-[#DDC7BB]/60 backdrop-blur-xl shadow-2xl shadow-[#2b1b1212] absolute z-10 flex items-center gap-6 rounded-xl -bottom-20">
        <label htmlFor="location" className="flex items-center justify-between bg-[#FBF5F1] rounded-xl outline-hidden pr-4 h-16">
          <input
        ...
        <label htmlFor="type" className="flex items-center justify-between bg-[#FBF5F1] rounded-xl outline-hidden pr-4 h-16">
          <input
            className="rounded-l-xl pl-5 h-full"
            type="text"
            placeholder="Type"
        ...
        <label htmlFor="price_range" className="flex items-center justify-between bg-[#FBF5F1] rounded-xl outline-hidden pr-4 h-16">
          <input
            className="rounded-l-xl pl-5 h-full"
            type="text"
